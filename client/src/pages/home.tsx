    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 relative overflow-hidden flex flex-col items-center justify-center transition-colors duration-300">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto">
          Cree campañas, gestione candidatos y recopile votos de forma segura con nuestra interfaz PWA protegida criptográficamente.
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/admin" className="w-full sm:w-auto px-8 py-4 rounded-2xl font-bold text-lg bg-slate-900 dark:bg-white dark:text-slate-900 text-white shadow-xl shadow-slate-900/20 hover:bg-slate-800 dark:hover:bg-slate-200 hover:-translate-y-1 transition-all">
          ...
          <div className="w-full sm:w-auto relative group">
            ...
            <Link href="/vote/example" className="relative w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-bold text-lg bg-white dark:bg-slate-900 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-800 hover:-translate-y-1 transition-all">
               Ver Demo de Votación <Megaphone className="w-5 h-5 text-primary" />
            </Link>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm p-6 rounded-3xl border border-slate-200/50 dark:border-slate-800 shadow-sm">
          ...
          <h3 className="font-display font-bold text-xl text-slate-900 dark:text-white mb-2">Identificación Única</h3>
          <p className="text-slate-600 dark:text-slate-400 text-sm">Los votantes se autentican de forma segura garantizando exactamente un voto por persona por campaña.</p>
        </div>
        <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm p-6 rounded-3xl border border-slate-200/50 dark:border-slate-800 shadow-sm">
          ...
          <h3 className="font-display font-bold text-xl text-slate-900 dark:text-white mb-2">Configuración Instantánea</h3>
          <p className="text-slate-600 dark:text-slate-400 text-sm">Implemente un enlace de votación personalizado con candidatos y descripciones en segundos.</p>
        </div>
        <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm p-6 rounded-3xl border border-slate-200/50 dark:border-slate-800 shadow-sm">
          ...
          <h3 className="font-display font-bold text-xl text-slate-900 dark:text-white mb-2">Registros Inmutables</h3>
          <p className="text-slate-600 dark:text-slate-400 text-sm">Todos los registros de votación se almacenan de forma segura con estrictas restricciones de integridad.</p>
        </div>
      </motion.div>
    </div>
  );
